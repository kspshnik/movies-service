  ...
  return (
    <main>
      ...
      <section id='tech' className='landing__section'>
        ...
        <p className='landing__text landing__text_centered'>
      ...
      <section id='student' className='landing__section'>
        ...
        <div className='landing__student'>
          <img
            ...
            src='https://kspshnik.com/pub/img/ek-avatar.jpg'
            alt='Евгений Карпель, немного мультяшный :)' />
            ...
            <ul className='landing__social'>
              <li className='landing__social-item'>
                <a
                  ...
                  target='_blank'
                  href='https://www.facebook.com/kspshnik'
                  rel='noreferrer'>
                  Facebook
                </a>
              </li>
              <li className='landing__social-item'>
                <a
                  className='landing__social-link'
                  target='_blank'
                  href='https://www.github.com/kspshnik'
                  rel='noreferrer'>
                  GitHub
                </a>
              </li>
        ...
        <div className='landing__portfolio'>
          ...
          <ul className='landing__portfolio-sites'>
            <li className='landing__portfolio-item'>
              ...
              <a
                className='landing__portfolio-sitename landing__portfolio-link'
                target='_blank'
                href='https://kspshnik.com/how-to-learn'
                rel='noreferrer'>
                ↗
              </a>
            </li>
            <li className='landing__portfolio-item'>
              ...
              <a
                className='landing__portfolio-sitename landing__portfolio-link'
                target='_blank'
                href='https://kspshnik.com/russian-travel'
                rel='noreferrer'>
                ↗
              </a>
            </li>
